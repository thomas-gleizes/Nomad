//! `nomad-input` — abstraction cross-OS de la capture et de l'injection d'entrées.
//!
...
//! - [`keymap`] : tables de correspondance rdev ↔ `nomad_core` ↔ enigo.
//!
//! Le découpage isole les deux crates OS sensibles derrière un vocabulaire neutre
//! (`nomad_core::{InputEvent, Key, Button}`), ce qui rend l'orchestration testable.
